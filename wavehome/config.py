...
LOCAL_CAMERA_SCAN_LIMIT = 5
LOCAL_CAMERA_BLACK_MEAN_THRESHOLD = 6.0
LOCAL_CAMERA_BLACK_STD_THRESHOLD = 4.0
...
COLOR_ARM_TIMEOUT_SECONDS = 8.0
COLOR_MIN_ANGLE_DEGREES = -60.0
COLOR_MAX_ANGLE_DEGREES = 60.0

PARTY_SEQUENCE = ("FIST", "HORNS", "FIST")
PARTY_SEQUENCE_TIMEOUT_SECONDS = 10.0
PARTY_HUE_CYCLE_SECONDS = 2.4
PARTY_BLINK_SECONDS = 0.22
